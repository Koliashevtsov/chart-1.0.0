...
export { Dataset, ExtendedDataset, Data, DefOptions, TDefGridOpt, Options, InputOptions, InputPlugin, HorizontalScrollingInputProp, DateTimeLabelsInputProp, InitSettings, TObserver, CoreProps, ConfigProps, PrivateConfig, IConfig, TController, IPlugins, IBeforeConfigInitPlugin, IAfterConfigInitPlugin, TPointPath, TState, TTooltips, Point, TDefSizes, ASizes, APoints, Offset, GridOpt, DrawingInitProps, AreaDrawProps, ClientRectType, Couples, Message, Color, NotifyFull, CustomEventHandler, InitHandlerProps, HoverConfUpd, HorScrolPlugUpd, HorScrolPlugOptions };
