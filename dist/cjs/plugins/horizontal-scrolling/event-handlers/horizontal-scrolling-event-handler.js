...
class HorizontalScrollingEventHandler {
    ...
    _resize(direction) {
        ...
        const { width, labelsCount } = (0, helpers_1.resizedChartAreaWidth)(this.pluginOptions.labelsStep, this.config.areasSizes.white.width, this.offset.distanceX);
        // rewrite right boundary
        this.rightBoundary = this.config.areasSizes.white.width - width;
        // calculate idxs
        const [startIdx, finishIdx] = (0, helpers_1.getIdxsSlice)(this.pluginOptions.originalConfig.data, this.pluginOptions.labelsOffset, labelsCount, this.pluginOptions.labelsStep);
        // rewrite data slice
        const data = (0, helpers_1.getDataSlice)(this.pluginOptions.originalConfig.data, startIdx, finishIdx);
        return (0, helpers_1.updatedConfigProps)(this.pluginOptions.originalConfig, data, this.offset, width, this.config.areasSizes.chart.height);
    }
...
exports.default = HorizontalScrollingEventHandler;
